const CACHE_NAME="spy-turtle-v5";
...
self.addEventListener("fetch",event=>{
    ...
    if(url.pathname==="/"||url.pathname.endsWith(".html")||url.pathname.endsWith(".css")||url.pathname.endsWith(".js")||url.pathname.startsWith("/camera/")||url.pathname.startsWith("/photos")||url.pathname==="/logs"||url.pathname==="/state"||url.pathname==="/health"||url.pathname==="/assets"){
