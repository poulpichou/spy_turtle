const CACHE_NAME="spy-turtle-v6";
...
if(url.pathname==="/"||url.pathname.endsWith(".html")||url.pathname.endsWith(".css")||url.pathname.endsWith(".js")||url.pathname.startsWith("/camera/")||url.pathname.startsWith("/photos")||url.pathname==="/logs"||url.pathname==="/state"||url.pathname==="/health"||url.pathname==="/assets"){event.respondWith(fetch(event.request,{cache:"no-store"}));return}
