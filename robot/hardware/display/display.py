...
class Display:
    ...
    def __init__(self):
        self.driver=ST7796()
        self.image=Image.new("RGB",(self.driver.width,self.driver.height),self.BLACK)
    ...
    def clear(self,color=BLACK):
        self.image=Image.new("RGB",(self.driver.width,self.driver.height),color)
        self.draw=ImageDraw.Draw(self.image)
    ...
    def image(self,path):
        self.image=Image.open(path).convert("RGB").resize((self.driver.width,self.driver.height))
        self.draw=ImageDraw.Draw(self.image)

    def show(self):
        pixels=[]

        for r,g,b in self.image.getdata():
